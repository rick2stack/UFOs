...
<body class="bg-dark">
    <div class="wrapper">
        <!-- the nav bar helps respond when viewing -->
        <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
            <!--- once button is click redirect to the original index.html-->
            <a class="navbar-brand" href="index.html">UFO Sightings</a>
        </nav>
        <div class="jumbotron bg-dark">
            <h1 class="display-4 text-danger">The Truth Is Out There</h1>
        </div>
    ...
    <!--the order at which you add the scripts matter-->
    <!--scripts are -->
    </div>
